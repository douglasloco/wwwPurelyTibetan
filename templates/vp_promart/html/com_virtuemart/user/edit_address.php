...
// echo 'rview = '.$rview;
    ...
    <?php if (!VmConfig::get('oncheckout_only_registered', 0)) { ?>
		...
		<?php } ?>
    	    <button class="default btn" type="reset" onclick="window.location.href='<?php echo JRoute::_('index.php?option=com_virtuemart&view=' . $rview); ?>'" ><?php echo JText::_('COM_VIRTUEMART_CANCEL'); ?></button>
