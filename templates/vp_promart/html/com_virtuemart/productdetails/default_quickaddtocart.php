...
<div class="addtocart-area">
	<form method="post" class="product js-recalculate" action="index.php" target="_parent" >
		    	...
		    	<div class="product-field product-field-type-<?php echo $field->field_type ?>">
						...
						if (!empty($field->custom_field_desc)) {
							...
							if (strpos($field->custom_field_desc,'||') == false and strpos($field->custom_field_desc,'[') !== false and strpos($field->custom_field_desc,']') !== false ) {
								...
								echo '<div class="product-field-desc">'.$field->custom_field_desc.'</div>';
							}						
						}	?>					
		    </div>
			<?php } 
...
<?php // Display the quantity box
 ...
 ?>
		<a href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=productdetails&layout=notify&virtuemart_product_id='.$this->product->virtuemart_product_id); ?>" class="notify btn btn-info" target="_parent"><?php echo JText::_('COM_VIRTUEMART_CART_NOTIFY') ?></a>
